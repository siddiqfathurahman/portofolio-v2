        ...
        <div className="flex items-center gap-4 mb-4">
          ...
          <div className="flex flex-col w-full">
            <div className="flex justify-between items-center">
              <h1 className="font-bold md:text-lg text-sm">SMKN 2 YOGYAKARTA</h1>
              <h2 className="text-gray-800 font-semibold text-xs md:text-sm">2022 - 2026</h2>
            </div>
            <h3 className="text-gray-600 text-xs md:text-base">Sistem Informasi Jaringan dan Aplikasi</h3>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <IoLocationSharp className="md:text-2xl text-xl" />
          <h2 className="text-xs md:text-base">Kota Yogyakarta, Daerah Istimewa Yogyakarta</h2>
        </div>
      </div>
    </div>
  );
