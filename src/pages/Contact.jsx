  ...
  return (
    <div className="text-center font-poppins pb-20 bg-slate-100 pt-44">
      <h1 className="md:text-5xl text-2xl text-gray-800 font-extrabold px-2 max-w-[1000px] mx-auto">
        ...
        <span className="text-blue-800"> functional</span>, and{" "}
        <span className="text-purple-800">high-quality</span> website? Let's
        bring your vision to
        <span className="text-yellow-500"> life!</span>
      </h1>

      <h2 className="md:text-5xl text-3xl font-extrabold mt-12">
        Contact Me 👇
      </h2>
      ...
      <div className="pt-8 flex justify-center items-center gap-4 relative min-h-[100px]">
        <a
          ...
          aria-label="Instagram - @fatrhmnnn"
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          aria-label="GitHub - @siddiqfathurahman"
